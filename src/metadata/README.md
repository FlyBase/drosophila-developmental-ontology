 ...
 * [fbdv.yml](fbdv.yml)
     * Determines how your purl.obolibrary.org/obo/fbdv/ redirects will be handled
     ...
     * Paste in the contents of [fbdv.yml](fbdv.yml)
 ...
 * [fbdv.md](fbdv.md)
     ...
     * Paste in the contents of [fbdv.md](fbdv.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
