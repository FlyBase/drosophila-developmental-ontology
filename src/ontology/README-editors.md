...
1. Reference an external ontology class in the edit ontology. In Protege: "add new entity" and paste in the PURL, then add a relationship to the new term from an fbdv term.
