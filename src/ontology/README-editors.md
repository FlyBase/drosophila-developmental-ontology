...
Make sure you have an ID range in the [idranges file](fbdv-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [fbdv-edit.owl](fbdv-edit.owl)

** DO NOT EDIT fbdv.obo OR fbdv.owl in the top level directory **

[../../fbdv.owl](../../fbdv.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/FlyBase/flybase-developmental-ontology) for details.
 ...
 * [fbdv-idranges.owl](fbdv-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/fbdv_terms.txt file
...
Note: the fbdv_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as fbdv.owl and fbdv.obo and places
 ...
 * https://github.com/FlyBase/flybase-developmental-ontology/releases
 * https://github.com/FlyBase/flybase-developmental-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived fbdv.owl (`data-version` in
fbdv.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/fbdv/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/FlyBase/flybase-developmental-ontology.svg?branch=master)](https://travis-ci.org/FlyBase/flybase-developmental-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/FlyBase](https://travis-ci.org/profile/FlyBase)
 2. click the "Sync account" button
 3. Click the tick symbol next to flybase-developmental-ontology
